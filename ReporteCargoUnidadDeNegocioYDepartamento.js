class ReporteCargoUnidadDeNegocioYDepartamento extends ReporteSelva {
    ...
    loadData() {
        ...
        super.loadData(() => {
            ...
            KMessage("servidor", payload, "CARGAR_EVALUACIONES_POR_CARGOS_POR_UNIDAD_DE_NEGOCIOS_Y_DEPARTAMENTOS", payload)
                .send(this.server)
                .then((data) => {
...
new ReporteCargoUnidadDeNegocioYDepartamento().register();